import { BetterDataProvider, SKDelta, SKUpdate, SKValue } from '@aldis/strongly-signalk';
...
stories.add('Showing three columns and three lines', () => {
  ...
  delta.updates.push(new SKUpdate(new Date("2018-08-08T16:20:01"), [
  ...
  delta.updates.push(new SKUpdate(new Date("2018-08-08T16:20:34"), [
  ...
  delta.updates.push(new SKUpdate(new Date("2018-08-08T16:21:01"), [
